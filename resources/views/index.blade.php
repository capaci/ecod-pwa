            ...
            <div class="col m9">
                <div class="row">
                    ...
                    <div class="col s12 m7">
                        <div class="input-field col s12">
                            <input type="date" class="datepicker validate">
                    ...
                    <div class="col s12 m5">
                        <div class="gender-select input-field col s12">
                            <select class="gender-select__button">
                ...
                <div class="row">
                    <div class="col s12 m8">
                        ...
                        <div class="col s12">
                            ...
                            <div class="input-field col s7">
                                <input name="nome-médico" type="text" id="nome-médico" class="validate"/>
                                <label for="nome-médico">Nome do Médico</label>
                            </div>
                            <div class="input-field col s5">
                                <input name="tel-médico" type="text" id="tel-médico" class="validate"/>
                                <label for="tel-médico">Telefone do Familiar 2</label>
                            </div>
                            <div class="input-field col s7">
                    ...
                    <div class="col s12 anamnese">
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" id="tabagismo" />
                                        <label for="tabagismo">Tabagismo</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" id="sedentarismo" />
                                        <label for="sedentarismo">Tabagismo</label>
                                    </p>
                                </div>
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" id="etilismo" />
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" id="musculoesquelética"/>
                                    ...
                                    <p>
                                        <input type="checkbox" id="uroginecologia"/>
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                ...
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" id="degenerativas"/>
                                        <label for="degenerativas">Doenças degenerativas</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" id="vasculares"/>
                                        <label for="vasculares">Doenças Vasculares </label>
                                    </p>
                                    <p>
                                        <input type="checkbox" id="neurologicas"/>
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea id="cirurgias" class="materialize-textarea"></textarea>
