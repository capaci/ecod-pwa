...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="assets/css/timeline.css" media="screen,projection"/>
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="input-field col s12">
                            <input id="complete_name" type="text" class="validate" disabled value="Fulaninho da Silva Sauro">
                            <label for="complete_name">Nome Completo</label>
                        </div>
                    </div>
                    <div class="col s12 m7">
                        <div class="input-field col s12">
                            <input type="text" class="validate"  disabled value="20/08/1990">
                            <label for="date">Data de Nascimento</label>
                        </div>
                        <div class="input-field col s12">
                            <input id="nacionalidade" type="text" class="validate" disabled value="Brasileiro">
                    ...
                    <div class="col s12 m5">
                        ...
                        <div id="custom-gender" class="input-field col s12 hide">
                            <input name="gender" type="text" id="custom-gender__input" class="validate"/>
                    ...
                    <div class="col s12 m8">
                        ...
                        <div class="col s12">
                            ...
                            <div class="input-field col s7">
                                <input name="nome-familiar1" type="text" id="nome-familiar1" class="validate" disabled value="Xablito da Silva"/>
                                <label for="nome-familiar1">Nome do Familiar 1</label>
                            </div>
                            <div class="input-field col s5">
                                <input name="tel-familiar1" type="text" id="tel-familiar1" class="validate" disabled value="+55 41 999884321"/>
                                <label for="tel-familiar1">Telefone do Familiar 1</label>
                            </div>
                            <div class="input-field col s7">
                                <input name="nome-familiar2" type="text" id="nome-familiar2" class="validate" disabled value="Xaublina de Souza e Silva"/>
                                <label for="nome-familiar2">Nome do Familiar 2</label>
                            </div>
                            <div class="input-field col s5">
                                <input name="tel-familiar2" type="text" id="tel-familiar2" class="validate" disabled value="+55 41 999774321"/>
                                <label for="tel-familiar2">Telefone do Familiar 2</label>
                            </div>
                            <div class="input-field col s7">
                                <input name="nome-médico" type="text" id="nome-médico" class="validate" disabled value="Jeremias Mewth"/>
                                <label for="nome-médico">Nome do Médico</label>
                            </div>
                            <div class="input-field col s5">
                                <input name="tel-médico" type="text" id="tel-médico" class="validate" disabled value="+55 41 999880001"/>
                                <label for="tel-médico">Telefone do Médico</label>
                            </div>
                            <div class="input-field col s7">
                                <input name="nome-plano" type="text" id="nome-plano" class="validate" disabled value="Unimed"/>
                                <label for="nome-plano">Plano de saúde</label>
                            </div>
                            <div class="input-field col s5">
                                <input name="tel-plano" type="text" id="tel-plano" class="validate" disabled value="+55 41 30332244"/>
                    ...
                    <div class="col s12 anamnese">
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" id="tabagismo" checked disabled/>
                                        <label for="tabagismo">Tabagismo</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="sedentarismo" />
                                        <label for="sedentarismo">Sedentarismo</label>
                                    </p>
                                </div>
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" id="etilismo" checked disabled/>
                                        <label for="etilismo">Etilismo</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="atividade-fisica" />
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" disabled id="musculoesquelética"/>
                                        <label for="musculoesquelética">Musculoesquelética</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="cardiovascular"/>
                                        <label for="cardiovascular">Cardiovascular</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="uroginecologia"/>
                                        <label for="uroginecologia">Uroginecologia</label>
                                    </p>
                                </div>
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" disabled id="etilismo" />
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" disabled id="hipertensao"/>
                                        <label for="hipertensao">Hipertensão</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="diabetes"/>
                                        <label for="diabetes">Diabetes</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="CA"/>
                                        <label for="CA">CA</label>
                                    </p>
                                </div>
                                <div class="col s6">
                                    <p>
                                        <input type="checkbox" disabled id="degenerativas"/>
                                        <label for="degenerativas">Doenças degenerativas</label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="vasculares"/>
                                        <label for="vasculares">Doenças Vasculares </label>
                                    </p>
                                    <p>
                                        <input type="checkbox" disabled id="neurologicas"/>
                        ...
                        <div class="anamnese__group">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea id="cirurgias" class="materialize-textarea" disabled>Perna direita foi quebrada uma vez. Nenhuma internação.</textarea>
